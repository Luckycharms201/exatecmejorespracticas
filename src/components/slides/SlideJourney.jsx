 ...
 * Camino horizontal con hitos numerados y línea trazada; al pie, el
 * crecimiento de participación. `highlight` (índice) resalta el punto en turno
 * (nodo más grande + glow). Es estática; el recorrido se arma con slides
 * separadas (roadmap + popups) en la secuencia.
 */
          ...
          {points.map((p, i) => {
            ...
            return (
              <div key={i} className="relative flex flex-1 flex-col items-center">
                ...
                {/* la escala activa va en el wrapper para no chocar con el
                    transform que deja la animación de entrada en .journey-node */}
                <div
